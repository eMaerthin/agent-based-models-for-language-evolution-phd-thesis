...
\doublespacing
\include{Introduction}											% ch:Intro
\include{Introduction_Overview}
\include{Introduction_Categories}

\include{Data}
\include{Data_Examples}
\include{Data_Classification}
\include{Data_Protocol}
\include{Data_Ideas}
\include{Data_Ideas_Prisoners}
\include{Data_Ideas_Animal}

\include{Theory}
\include{Theory_Model}
\include{Theory_Observables}
\include{Theory_Discrete}
\include{Theory_Continuous}
\include{Theory_Broadcast}
\include{Theory_Threshold}
\include{Theory_Discussion}

\include{Simulation}
\include{Simulation_Sensitivity}
\include{Simulation_Results}
\include{Simulation_Interpretation}
\include{Simulation_Validation}

\include{Analytic}
\include{Analytic_Explicit}
\include{Analytic_WFExtended}

\include{Implementation}

\include{Summary}
\include{Summary_Conclusions}
\include{Summary_Future}
\include{Summary_Problems}
